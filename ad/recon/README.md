...
* The location of the **domain controllers** (and other major AD services like KDC, DNS and so on). This can be achieved by [resolving standard names](/broken/pages/byUqwWh4MzHCAqOzZsfW), by [scanning the network](network/port-scanning.md) and with [standard LDAP queries](network/ldap.md)
...
* **Domain objects** and relations between them with [BloodHound](/broken/pages/LC5HbzI57PEFYfKswdsj), with [MS-RPC named pipes](network/ms-rpc.md) and with [enum4linux](tools/enum4linux.md).
