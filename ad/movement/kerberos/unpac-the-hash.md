...
The NT hash can be used for [pass-the-hash](/broken/pages/6MHzmbXpK7Ge11Xc9oZf), [silver ticket](forged-tickets/#silver-ticket), or [Kerberos delegations](delegations/) abuse.
{% endtab %}
