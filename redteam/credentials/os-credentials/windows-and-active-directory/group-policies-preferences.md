...
* **Issue 2**: by default, knowing the built-in Administrator's hash (RID 500) allows for powerful [Pass-the-Hash](../../../../ad/movement/ntlm/pth.md) attacks ([read more](/broken/pages/6MHzmbXpK7Ge11Xc9oZf#limitations-tips-and-tricks)).
