...
In order to fine-tune this, the password policy can be obtained. This policy can sometimes be enumerated with a null-session (i.e. an [MS-RPC null session](/ad/recon/network/ms-rpc) or an [LDAP anonymous bind](/ad/recon/network/ldap)).
