...
<Tabs items={['Dump All DACLs', 'Dump All DACLs for Current User', 'Interesting DACLs']}>
<Tab value="Dump All DACLs">
...
<Tab value="Dump All DACLs for Current User">
...
<ResourceCard href="https://www.ired.team/offensive-security-experiments/active-directory-kerberos-abuse/using-dsacls-to-check-ad-object-permissions" title="Enumerating AD Object Permissions with dsacls | Red Team Notes" description="www.ired.team" />
