...
<ResourceCard href="https://book.hacktricks.xyz/windows-hardening/basic-powershell-for-pentesters/powerview" title="PowerView/SharpView - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />
