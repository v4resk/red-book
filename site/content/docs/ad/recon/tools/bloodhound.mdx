...
<ResourceCard href="https://bloodhound.readthedocs.io/en/latest/" title="BloodHound: Six Degrees of Domain Admin  BloodHound 4.3.1 documentation" description="bloodhound.readthedocs.io" icon="/assets/favicons/bloodhound.readthedocs.io.png" />
