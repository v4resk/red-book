...
[Responder](https://github.com/lgandx/Responder) (Python) is a great tool for [LLMNR, NBTNS, MDNS poisoning](/ad/movement/mitm-and-coerced-authentications/llmnr-nbtns-mdns-spoofing) and [WPAD spoofing](/ad/movement/mitm-and-coerced-authentications/wpad-spoofing) but it can also be used in "analyze" modes.
...
<ResourceCard href="https://www.trustwave.com/en-us/resources/blogs/spiderlabs-blog/responder-20-owning-windows-networks-part-3/" title="www.trustwave.com" description="www.trustwave.com" icon="/assets/favicons/www.trustwave.com.png" />
