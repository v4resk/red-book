...
1. [dump some information relative to the gMSA account](/ad/persistence/goldengmsa#2.-account-information-dump) to retrieve the password for
2. use those elements to [calculate the gMSA password](/ad/persistence/goldengmsa#3.-password-calculation)
...
In order to use the password, its MD4 (i.e. NT) hash can be calculated, for [Broken link](/ad/movement/ntlm/pth "mention").
