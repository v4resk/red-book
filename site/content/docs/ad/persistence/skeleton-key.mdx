...
<Tabs items={['NTLM auth', 'Kerberos auth']}>
<Tab value="NTLM auth">
...
![Skeleton key injection and usage illustration on a Windows Server 2019](/assets/mimikatz_skeleton_key_ws2019.png)

## Resources

<ResourceCard href="https://adsecurity.org/?p=1255" title="Active Directory Domain Controller Skeleton Key Malware & Mimikatz" description="adsecurity.org" icon="/assets/favicons/adsecurity.org.ico" />

<ResourceCard href="https://pentestlab.blog/2018/04/10/skeleton-key" title="Skeleton Key" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.ico" />

<ResourceCard href="https://www.virusbulletin.com/uploads/pdf/magazine/2016/vb201601-skeleton-key.pdf" title="www.virusbulletin.com" description="www.virusbulletin.com" icon="/assets/favicons/www.virusbulletin.com.png" />
