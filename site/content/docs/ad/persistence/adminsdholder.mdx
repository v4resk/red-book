...
<ResourceCard href="https://adsecurity.org/?p=1906" title="Sneaky Active Directory Persistence #15: Leverage AdminSDHolder & SDProp to (Re)Gain Domain Admin Rights" description="adsecurity.org" icon="/assets/favicons/adsecurity.org.ico" />

<ResourceCard href="https://docs.microsoft.com/en-us/archive/blogs/askds/five-common-questions-about-adminsdholder-and-sdprop" title="Five common questions about AdminSdHolder and SDProp" description="docs.microsoft.com" icon="/assets/favicons/docs.microsoft.com.png" />

<ResourceCard href="https://www.ired.team/offensive-security-experiments/active-directory-kerberos-abuse/how-to-abuse-and-backdoor-adminsdholder-to-obtain-domain-admin-persistence" title="Backdooring AdminSDHolder for Persistence | Red Team Notes" description="www.ired.team" />
