...
This page is about persitence, you may have a look on [LAPS-based attacks](/ad/recon/objects-and-settings/laps) and [LAPS enumeration](/ad/recon/objects-and-settings/laps).
...
<ResourceCard href="https://ppn.snovvcrash.rocks/pentest/infrastructure/ad/laps#backdoor" title="ppn.snovvcrash.rocks" description="ppn.snovvcrash.rocks" />

<ResourceCard href="https://book.hacktricks.xyz/windows-hardening/active-directory-methodology/laps#backdoor" title="LAPS - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />
