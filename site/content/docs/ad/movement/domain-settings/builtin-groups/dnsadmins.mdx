...
<ResourceCard href="https://malicious.link/post/2020/compiling-a-dll-using-mingw/" title="Compiling a DLL using MingGW" description="malicious.link" icon="/assets/favicons/malicious.link.ico" />
