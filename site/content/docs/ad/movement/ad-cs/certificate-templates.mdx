...
The certificate can then be used with [Pass-the-Certificate](/ad/movement/kerberos/pass-the-certificate) to obtain a TGT and authenticate.
...
The certificate can then be used with [Pass-the-Certificate](/ad/movement/kerberos/pass-the-certificate) to obtain a TGT and authenticate as the controlled principal, but with its privileges added to those of the linked group.
...
The certificate can then be used with [Pass-the-Certificate](/ad/movement/kerberos/pass-the-certificate) to obtain a TGT and authenticate as the target.
