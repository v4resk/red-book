...
The attacker can add an SPN (`ServicePrincipalName`) to that account. Once the account has an SPN, it becomes vulnerable to [Kerberoasting](/ad/movement/kerberos/kerberoast). This technique is called Targeted Kerberoasting.
