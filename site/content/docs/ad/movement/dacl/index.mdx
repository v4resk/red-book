...
<Card href="../../recon/objects-and-settings/dacls.md" title="dacls.md" />

### Abuse

In order to navigate the notes, testers can use the mindmap below.

![](&lt;/assets/spaces_-MHRw3PMJtbDDjbxm5ub_uploads_ntRNzbqz7Ji1ZB1kjrqp_DACL abuse-dark.png>)
...
* User and computers objects can conduct a [Kerberos RCD](/ad/movement/kerberos/delegations#resource-based-constrained-delegations-rbcd) attack on themselves.
