...
This page is about LAPS-based attacks, you may have a look on [LAPS-based persistences](/ad/persistence/laps) and [LAPS enumeration](/ad/recon/objects-and-settings/laps).
...
<ResourceCard href="https://simondotsh.com/infosec/2022/07/11/dirsync.html" title="DirSync: Leveraging Replication Get-Changes and Get-Changes-In-Filtered-Set" description="simondotsh.com" />
