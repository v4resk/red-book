...
When forging a[ referral ticket](/ad/movement/domain-trusts#referral-ticket), or a [golden ticket](/ad/movement/domain-trusts#golden-ticket), additional security identifiers (SIDs) can be added as "extra SID" and be considered as part of the user's [SID history](/ad/movement/domain-trusts#sid-history) when authenticating.
