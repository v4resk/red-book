...
<Tabs items={['UNIX-like (from outside)', 'Windows (from inside)']}>
<Tab value="UNIX-like (from outside)">
...
<Card href="/ad/movement/exchange-services/privexchange" title="PrivExchange" />

<Card href="/ad/movement/exchange-services/proxylogon" title="ProxyLogon" />

<Card href="/ad/movement/exchange-services/proxyshell" title="ProxyShell" />

<Card href="/ad/movement/exchange-services/proxynotshell" title="ProxyNotShell" />

### Password Spray

Password spray is an attack that involves using a single password against multiple accounts. This avoids account lockouts when multiple passwords are used on a single account. More details [on this page](/redteam/delivery/password-attacks).
...
<ResourceCard href="https://ppn.snovvcra.sh/pentest/perimeter/exchange" title="Exchange | Pentester&#x27;s Promiscuous Notebook" description="ppn.snovvcra.sh" />
