...
Attacking Active Directory domains often leads to obtaining password interesting, but either hashed or encrypted data. When this information cannot be directly leveraged for higher privileges (like with [pass-the-hash](/ad/movement/ntlm/pth), [overpass-the-hash](/ad/movement/kerberos/pass-the/ptk)), it is required to crack it.
...
| LM hash                                                                  | 3000                                                                                 |
| NT hash                                                                  | 1000                                                                                 |
| [LM response](/ad/movement/ntlm/capture)                                        | [not supported](https://github.com/hashcat/hashcat/issues/78#issuecomment-276048841) |
| [LMv2 response](/ad/movement/ntlm/capture)                                      | [not supported](https://github.com/hashcat/hashcat/issues/78#issuecomment-276048841) |
| [NTLM response](/ad/movement/ntlm/capture)                                      | 5500                                                                                 |
| [NTLMv2 response](/ad/movement/ntlm/capture)                                    | 5600                                                                                 |
| [(DCC1) Domain Cached Credentials](/redteam/credentials/os-credentials/windows-and-active-directory/sam-and-lsa-secrets)   | 1100                                                                                 |
| [(DCC2) Domain Cached Credentials 2](/redteam/credentials/os-credentials/windows-and-active-directory/sam-and-lsa-secrets) | 2100                                                                                 |
| [ASREQroast](/ad/movement/kerberos/roasting/asreqroast)                                  | 7500                                                                                 |
| [ASREProast](/ad/movement/kerberos/roasting/asreproast)                         | 18200                                                                                |
| [Kerberoast](/ad/movement/kerberos/roasting/kerberoast)                         | 13100                                                                                |
...
A robust alternative to hashcat is [John the Ripper](https://github.com/openwall/john), a.k.a. john (C). Its main strength is a large community that regularly releases "something2john" tools that convert things to a john-crackable format (e.g. `bitlocker2john`, `1password2john`, `keepass2john`, `lastpass2john` and so on).
...
* LM and NTLM ChallengeResponses can be cracked really fast (and for free depending on the hash) on [crack.sh](https://crack.sh/get-cracking/), a remote service that cracks the hash with rainbow tables ([here's how to capture those hashes](/ad/movement/ntlm/capture#practice)).
* Testers that manage to pwn a domain admin or a distributed local admin should try to operate multiple [LSASS dumps](/redteam/credentials/os-credentials/windows-and-active-directory/lsass) to create a custom wordlist for a dictionary attack
...
<ResourceCard href="https://hashcat.net/wiki/doku.php?id=example_hashes" title="example_hashes [hashcat wiki]" description="hashcat.net" icon="/assets/favicons/hashcat.net.ico" />
