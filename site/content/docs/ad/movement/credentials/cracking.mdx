...
<ResourceCard href="https://hashcat.net/wiki/doku.php?id=example_hashes" title="example_hashes [hashcat wiki]" description="hashcat.net" icon="/assets/favicons/hashcat.net.png" />
