...
In the situation where the tester doesn't have any credentials, it is still possible to [relay an authentication](/ad/movement/ntlm/relay) to make the API call.
