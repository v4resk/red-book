...
![Domain Controller > DNS Manager > zone properties > WINS](/assets/WINS_lookup.png)
...
* operate [LLMNR, NBT-NS and mDNS spoofing](/ad/movement/mitm-and-coerced-authentications/llmnr-nbtns-mdns-spoofing)
...
* set the Challenge to `1122334455667788` (to [crack NTLM hashes](/ad/movement/credentials/cracking#practice) with [crack.sh](https://crack.sh/))
...
<ResourceCard href="https://blog.netspi.com/exploiting-adidns/" title="Beyond LLMNR/NBNS Spoofing \u2013 Exploiting Active Directory-Integrated DNS" description="blog.netspi.com" icon="/assets/favicons/blog.netspi.com.png" />
...
<ResourceCard href="https://snovvcrash.rocks/2020/12/28/htb-hades.html#spoofing-active-directory-integrated-dns" title="snovvcrash.rocks" description="snovvcrash.rocks" icon="/assets/favicons/snovvcrash.rocks.ico" />
