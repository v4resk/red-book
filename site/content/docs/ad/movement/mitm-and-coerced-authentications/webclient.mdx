...
<ResourceCard href="https://pentestlab.blog/2021/10/20/lateral-movement-webclient" title="Lateral Movement \u2013 WebClient" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.png" />

<ResourceCard href="https://www.webdavsystem.com/server/access/windows" title="Connecting to WebDAV server on Microsoft Windows" description="www.webdavsystem.com" icon="/assets/favicons/www.webdavsystem.com.png" />
