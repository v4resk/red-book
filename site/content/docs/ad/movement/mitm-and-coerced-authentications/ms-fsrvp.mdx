...
<ResourceCard href="https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-fsrvp/dae107ec-8198-4778-a950-faa7edad125b" title="[MS-FSRVP]: File Server Remote VSS Protocol" description="docs.microsoft.com" icon="/assets/favicons/docs.microsoft.com.ico" />
