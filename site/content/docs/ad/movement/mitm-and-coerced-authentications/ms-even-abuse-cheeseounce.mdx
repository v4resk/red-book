---
title: "MS-EVEN abuse (CheeseOunce)"
---
...
<ResourceCard href="https://learn.microsoft.com/en-us/openspecs/windows_protocols/ms-even/55b13664-f739-4e4e-bd8d-04eeda59d09f" title="[MS-EVEN]: EventLog Remoting Protocol" description="learn.microsoft.com" icon="/assets/favicons/learn.microsoft.com.png" />

<ResourceCard href="https://github.com/evilashz/CheeseOunce" title="GitHub - evilashz/CheeseOunce: Coerce Windows machines auth via MS-EVEN" description="github.com" icon="/assets/favicons/github.com.png" />
