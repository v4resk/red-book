...
<ResourceCard href="https://docs.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2003/cc759554(v=ws.10)?redirectedfrom=MSDN" title="Trust Technologies: Domain and Forest Trusts" description="docs.microsoft.com" icon="/assets/favicons/docs.microsoft.com.ico" />
