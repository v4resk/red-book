...
<Card href="/ad/recon/objects-and-settings/group-policies" title="Group policies" />
...
<Card href="/redteam/credentials/os-credentials/windows-and-active-directory/group-policies-preferences" title="Group Policy Preferences" />
