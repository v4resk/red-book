...
There were many concepts to understand in the original exploit scenario (the "[password change](/ad/movement/netlogon/zerologon#password-change-disruptive)" one).
