...
Silver, Golden, Diamond and Sapphire tickets are forged or modified Kerberos tickets that can be used with [pass-the-ticket](/ad/movement/kerberos/ptt) to access services in an Active Directory domain.
