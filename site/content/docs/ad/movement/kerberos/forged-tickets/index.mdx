...
Silver, Golden, Diamond and Sapphire tickets are forged or modified Kerberos tickets that can be used with [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) to access services in an Active Directory domain.
...
<Card href="/ad/movement/kerberos/forged-tickets/diamond" title="Diamond tickets" />
...
<Card href="/ad/movement/kerberos/forged-tickets/sapphire" title="Sapphire tickets" />

The **Bronze bit** vulnerability (CVE-2020-17049) makes it possible to forward service tickets that normally could not be, bypassing two protections: accounts flagged "sensitive and cannot be delegated" (or in the Protected Users group), and [constrained delegation](/ad/movement/kerberos/delegations/constrained) configured **without** protocol transition.

![](/assets/Kerberos_delegation.png)
