...
<ResourceCard href="https://exploit.ph/user-constrained-delegation.html" title="eXploit - Abusing Users Configured with Unconstrained Delegation" description="exploit.ph" icon="/assets/favicons/exploit.ph.png" />
