...
The NT hash can be used for [pass-the-hash](/ad/movement/ntlm/pth), [silver ticket](/ad/movement/kerberos/forged-tickets), or [Kerberos delegations](/ad/movement/kerberos/delegations) abuse.
