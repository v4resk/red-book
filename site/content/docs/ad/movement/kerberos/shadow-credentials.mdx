...
When the public key has been set in the `msDs-KeyCredentialLink` of the target, the certificate generated can be used with [Pass-the-Certificate](/ad/movement/kerberos/pass-the-certificate) to obtain a TGT and further access.
