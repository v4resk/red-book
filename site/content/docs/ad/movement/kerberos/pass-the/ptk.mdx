...
* When the RC4 etype is enabled, the RC4 key can be used. The problem is that the RC4 key is in fact the user's NT hash. Using a an NT hash to obtain Kerberos tickets is called [**overpass the hash**](/ad/movement/kerberos/pass-the/opth).
...
Once a TGT is obtained, the tester can use it with the environment variable `KRB5CCNAME` with tools implementing [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt).
...
<ResourceCard href="https://blog.notso.pro/2020-05-09-offops-in-ad-1/" title="blog.notso.pro" description="blog.notso.pro" />

<ResourceCard href="http://blog.gentilkiwi.com/securite/mimikatz/overpass-the-hash" title="blog.gentilkiwi.com" description="blog.gentilkiwi.com" icon="/assets/favicons/blog.gentilkiwi.com.png" />

<ResourceCard href="https://blog.stealthbits.com/how-to-detect-overpass-the-hash-attacks/" title="blog.stealthbits.com" description="blog.stealthbits.com" />
