...
Once the final service ticket is obtained, it can be used with [Pass the Cache](/ad/movement/kerberos/pass-the/ptc) / [Pass the Ticket](/ad/movement/kerberos/pass-the/ptt) to access the target.
...
Once the final service ticket is obtained, it can be used with [Pass the Ticket](/ad/movement/kerberos/pass-the/ptt) to access the target.
...
<ResourceCard href="https://www.semperis.com/blog/spn-jacking-an-edge-case-in-writespn-abuse" title="www.semperis.com" description="www.semperis.com" icon="/assets/favicons/www.semperis.com.png" />
