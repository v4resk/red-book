...
<ResourceCard href="https://docs.microsoft.com/en-us/archive/blogs/josebda/the-basics-of-smb-signing-covering-both-smb1-and-smb2" title="The Basics of SMB Signing (covering both SMB1 and SMB2)" description="docs.microsoft.com" icon="/assets/favicons/docs.microsoft.com.ico" />
