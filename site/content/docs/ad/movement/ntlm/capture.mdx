...
In order to help the later [cracking process](/ad/movement/credentials/cracking#tips--tricks), testers need to set the NTLM challenge sent to victims to `1122334455667788`.
...
Machine account NT hashes can be used with the [Silver Ticket](/ad/movement/kerberos/forged-tickets) or [S4U2self abuse](/ad/movement/kerberos/delegations/s4u2self-abuse) techniques to gain admin access to it.
