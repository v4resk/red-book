...
<div align="center"><Figure src="/assets/image (19).png" /></div>

## Practice

<Tabs items={['Manualy', 'metasploit', 'icmpdoor']}>
<Tab value="Manualy">
...
<ResourceCard href="https://blog.bwlryq.net/posts/icmp_exfiltration/" title="bWlrYQ | Homepage" description="blog.bwlryq.net" icon="/assets/favicons/blog.bwlryq.net.ico" />

<ResourceCard href="https://tryhackme.com/room/dataxexfilt/" title="tryhackme.com" description="tryhackme.com" />

<ResourceCard href="https://www.atomicredteam.io/atomic-red-team/atomics/T1048.003" title="Atomic Red Team\u2122: T1048.003" description="www.atomicredteam.io" icon="/assets/favicons/www.atomicredteam.io.png" />
