---
title: "Exfiltration Over HTTP(s)"
...
We can also use [HTTP(S) Tunneling](/redteam/pivoting/http-tunneling) as a good [exfiltration](/redteam/exfiltration) channel.

</Callout>

## Practice

<Tabs items={['Linux - POST', 'Linux - PUT']}>
<Tab value="Linux - POST">
