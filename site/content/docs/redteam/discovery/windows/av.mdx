...
<Tabs items={['AntiVirus', 'Defenders', 'FireWalls', 'Sysmon', 'EDRs', 'AppLocker']}>
<Tab value="AntiVirus">
...
<ResourceCard href="https://tryhackme.com/room/thelayoftheland" title="tryhackme.com" description="tryhackme.com" />

<ResourceCard href="https://attack.mitre.org/techniques/T1518/001/" title="Software Discovery: Security Software Discovery, Sub-technique T1518.001 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
