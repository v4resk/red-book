...
To generate a rule-based wordlists, [see this page](/redteam/credentials/passwd/generate-wordlists#rules-based-wordlists).
...
<Tabs items={['CrackStation.net']}>
<Tab value="CrackStation.net">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1110/002/" title="Brute Force: Password Cracking, Sub-technique T1110.002 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />

<ResourceCard href="https://cheatsheet.haax.fr/passcracking-hashfiles/hashcat_cheatsheet/" title="cheatsheet.haax.fr" description="cheatsheet.haax.fr" />
