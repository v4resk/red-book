...
<Tabs items={['CeWL', 'User List', 'Crunch', 'CUPP - OSINT', 'LDAPWordlistHarvester']}>
<Tab value="CeWL">
...
<Tab value="LDAPWordlistHarvester">

[LDAPWordlistHarvester](https://github.com/p0dalirius/LDAPWordlistHarvester) is an other greate tool from [p0dalirius](https://github.com/p0dalirius). It generates a wordlist from the information present in [LDAP](/network-pentesting/protocols/ldap), in order to crack passwords of domain accounts.
...
<Tabs items={['Hashcat', 'John', 'Psudohash']}>
<Tab value="Hashcat">
...
Let's assume an [AD password policy](/ad/recon/objects-and-settings/password-policy) that requires an upper case letter, a special character, and a numerical value. We may use the following rules along with hashcat:
...
<ResourceCard href="https://tryhackme.com/room/passwordattacks" title="tryhackme.com" description="tryhackme.com" />
