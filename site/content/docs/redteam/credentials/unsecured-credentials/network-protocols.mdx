...
<Tabs items={['PCredz', 'tcpdump']}>
<Tab value="PCredz">

[PCredz ](https://github.com/lgandx/PCredz)(Python) is a good example and allows extraction of credit card numbers, NTLM (DCE-RPC, HTTP, SQL, LDAP, etc), Kerberos (AS-REQ Pre-Auth etype 23, i.e. [ASREQroast](/ad/movement/kerberos/asreqroast)), HTTP Basic, SNMP, POP, SMTP, FTP, IMAP, etc from a pcap file or from a live interface.
...
<ResourceCard href="https://github.com/lgandx/PCredz" title="GitHub - lgandx/PCredz: This tool extracts Credit card numbers, NTLM(DCE-RPC, HTTP, SQL, LDAP, etc), Kerberos " description="github.com" icon="/assets/favicons/github.com.png" />
