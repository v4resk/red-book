...
You may use this tools to search sensitives files in a [mounted NFS share](/network-pentesting/protocols/nfs#mount-nfs-shares), a [mounted SMB share](/network-pentesting/protocols/smb#acls-of-shares-filefolder), or even [exiltrated data](/redteam/exfiltration).
