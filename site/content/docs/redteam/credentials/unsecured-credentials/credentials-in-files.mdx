...
<Tabs items={['Noseyparker']}>
<Tab value="Noseyparker">
...
You may use this tools to search sensitives files in a [mounted NFS share](/network-pentesting/protocols/nfs#mount-nfs-shares), a [mounted SMB share](/network-pentesting/protocols/smb#acls-of-shares-file-folder), or even [exiltrated data](/redteam/exfiltration).
...
<ResourceCard href="https://attack.mitre.org/techniques/T1552/001/" title="Unsecured Credentials: Credentials In Files, Sub-technique T1552.001 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
