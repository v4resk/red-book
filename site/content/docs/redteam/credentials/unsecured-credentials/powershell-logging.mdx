...
<Tabs items={['Command History']}>
<Tab value="Command History">
...
<Tabs items={['Script Block Logging']}>
<Tab value="Script Block Logging">
...
<Tabs items={['Decrypting XML PSCredentials']}>
<Tab value="Decrypting XML PSCredentials">
...
<ResourceCard href="https://www.mandiant.com/resources/blog/greater-visibility" title="Mandiant Cybersecurity Consulting" description="www.mandiant.com" icon="/assets/favicons/www.mandiant.com.png" />

<ResourceCard href="https://attack.mitre.org/techniques/T1552/" title="Unsecured Credentials, Technique T1552 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
