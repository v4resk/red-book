...
<Tabs items={['Veeam-Get-creds', 'Veeampot', 'SQL Request', 'PowerShell Empire']}>
<Tab value="Veeam-Get-creds">
...
<Tabs items={['From Veeam Backup files', 'From Veeam Console']}>
<Tab value="From Veeam Backup files">
...
<Figure src="/assets/0_N6yuiYvbUpQUiF9s.webp" />
...
<Tabs items={['Dump Credentials', 'RCE']}>
<Tab value="Dump Credentials">
...
<ResourceCard href="https://medium.com/@_sadshade/veeam-backup-penetration-getting-the-most-out-of-pentest-17e0da021238" title="medium.com" description="medium.com" icon="/assets/favicons/medium.com.ico" />

<ResourceCard href="https://www.pwndefend.com/2021/02/15/retrieving-passwords-from-veeam-backup-servers/" title="Retrieving Passwords From Veeam Backup Servers \u2013 PwnDefend" description="www.pwndefend.com" icon="/assets/favicons/www.pwndefend.com.png" />

<ResourceCard href="https://forums.veeam.com/veeam-backup-replication-f2/recover-esxi-password-in-veeam-t34630.htm" title="forums.veeam.com" description="forums.veeam.com" icon="/assets/favicons/forums.veeam.com.png" />
