...
* [Built-in password managers (Windows)](/redteam/credentials/password-stores/windows-credential-manager)
...
Then, we may crack the master password using hashcat. See [this page](/redteam/credentials/passwd/brute-force/offline-password-cracking) for more details about cracking passwords.
...
<Tabs items={['ShellCode Injection']}>
<Tab value="ShellCode Injection">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1555/005/" title="Credentials from Password Stores: Password Managers, Sub-technique T1555.005 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />

<ResourceCard href="https://github.com/Orange-Cyberdefense/KeePwn" title="GitHub - Orange-Cyberdefense/KeePwn: A python tool to automate KeePass discovery and secret extraction." description="github.com" icon="/assets/favicons/github.com.png" />

<ResourceCard href="https://ppn.snovvcrash.rocks/pentest/infrastructure/ad/credential-harvesting/keepass" title="ppn.snovvcrash.rocks" description="ppn.snovvcrash.rocks" />
