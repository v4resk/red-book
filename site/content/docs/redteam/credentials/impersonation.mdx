...
* **RC4 Kerberos key (i.e. NT hash)**: [overpass-the-hash](/ad/movement/kerberos/ptk)
* **non-RC4 Kerberos key (i.e. DES or AES)**: [pass-the-key](/ad/movement/kerberos/ptk) (alias for overpass-the-hash)
* **Kerberos ticket**: [pass-the-ticket](/ad/movement/kerberos/ptt)
