...
<Tabs items={['ldbsearch', 'samba-tool', 'pdbedit (tdbsam only)']}>
<Tab value="ldbsearch">
...
<ResourceCard href="https://infosecwriteups.com/samba-active-directory-domain-controller-linux-what-to-do-when-impacket-bloodhound-dont-work-1faee4828d5b" title="infosecwriteups.com" description="infosecwriteups.com" icon="/assets/favicons/infosecwriteups.com.ico" />
