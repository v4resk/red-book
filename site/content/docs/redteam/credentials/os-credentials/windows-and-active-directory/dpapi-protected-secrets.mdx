...
[DonPAPI](https://github.com/login-securite/DonPAPI) (Python) can also be used to remotely extract a user's DPAPI secrets more easily. It supports [pass-the-hash](/ad/movement/ntlm/pth), [pass-the-ticket](/ad/movement/kerberos/ptt) and so on.
