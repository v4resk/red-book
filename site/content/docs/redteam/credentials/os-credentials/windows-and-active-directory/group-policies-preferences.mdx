...
* **Issue 2**: by default, knowing the built-in Administrator's hash (RID 500) allows for powerful [Pass-the-Hash](/ad/movement/ntlm/pth) attacks ([read more](/ad/movement/ntlm/pth#limitations-tips-and-tricks)).
...
In 2015, Microsoft removed storing the encrypted password in the SYSVOL folder. It introduced the [Local Administrator Password Solution (LAPS)](/ad/recon/objects-and-settings/laps), which offers a much more secure approach to remotely managing the local administrator password.
...
From Windows systems, the GPP password can only be recovered from an authenticated (i.e. domain user) context (see [impersonation](/redteam/credentials/impersonation)).
...
<ResourceCard href="https://adsecurity.org/?p=2288" title="Finding Passwords in SYSVOL & Exploiting Group Policy Preferences" description="adsecurity.org" icon="/assets/favicons/adsecurity.org.ico" />

<ResourceCard href="http://blog.carnal0wnage.com/2012/10/group-policy-preferences-and-getting.html" title="Group Policy Preferences and Getting Your Domain 0wned Carnal0wnage - Blog Carnal0wnage Blog" description="blog.carnal0wnage.com" icon="/assets/favicons/blog.carnal0wnage.com.png" />

<ResourceCard href="https://podalirius.net/en/articles/exploiting-windows-group-policy-preferences/" title="podalirius.net" description="podalirius.net" />

<ResourceCard href="https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-gppref/2c15cbf0-f086-4c74-8b70-1f2fa45dd4be" title="[MS-GPPREF]: Password Encryption" description="docs.microsoft.com" icon="/assets/favicons/docs.microsoft.com.ico" />
