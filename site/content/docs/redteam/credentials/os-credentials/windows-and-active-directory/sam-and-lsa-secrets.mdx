...
That's information are stored in registries, with the exception of domain controllers, which store the information in the [NTDS.dit](/redteam/credentials/os-credentials/windows-and-active-directory/ntds) file. SAM is accessible trought RPC.

<Figure src="/assets/SAM-internal-Schem(2).png" />
...
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Plaintext passwords                      | [credential spraying](/ad/movement/credentials/bruteforcing/password-spraying), [stuffing](/ad/movement/credentials/bruteforcing/stuffing), [shuffling](/ad/movement/credentials/credential-shuffling) or [silver tickets](/ad/movement/kerberos/forged-tickets/silver)                                     |
| LM and NT hashes                         | [credential spraying](/ad/movement/credentials/bruteforcing/password-spraying), [stuffing](/ad/movement/credentials/bruteforcing/stuffing), [shuffling](/ad/movement/credentials/credential-shuffling), [cracking](/ad/movement/credentials/cracking), [pass-the-hash](/ad/movement/ntlm/pth) |
| Kerberos keys (RC4, i.e. == NT hash)     | [credential cracking](/ad/movement/credentials/cracking), [overpass-the-hash](/ad/movement/kerberos/pass-the/ptk) or [silver tickets](/ad/movement/kerberos/forged-tickets/silver)                                                                                                                                                 |
| Kerberos keys (DES, AES)                 | [credential cracking](/ad/movement/credentials/cracking), [pass-the-key](/ad/movement/kerberos/pass-the/ptk) or [silver tickets](/ad/movement/kerberos/forged-tickets/silver)                                                                                                                                                      |
| Domain Cached Credentials (DCC1 or DCC2) | [credential cracking](/ad/movement/credentials/cracking)                                                                                                                                                                                                                                                                                              |

## Practice

<Tabs items={['UNIX-like', 'Live Windows', 'Down Windows']}>
<Tab value="UNIX-like">

#### Reg.py

[Impacket](https://github.com/SecureAuthCorp/impacket)'s reg.py (Python) script can be used to remotely save hives from an UNIX-like machine. For instance, this can be used to easily escalate from a [Backup Operator](/ad/movement/domain-settings/builtin-groups) member to a Domain Admin by dumping a Domain Controller's secrets and use them for a [DCSync](/redteam/credentials/os-credentials/windows-and-active-directory/dcsync).
...
[Impacket](https://github.com/SecureAuthCorp/impacket)'s [secretsdump](https://github.com/SecureAuthCorp/impacket/blob/master/examples/secretsdump.py) (Python) can be used to dump SAM and LSA secrets, either remotely, or from local files. For remote dumping, several authentication methods can be used like [pass-the-hash](/ad/movement/ntlm/pth) (LM/NTLM), or [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) (Kerberos).
...
[NetExec](https://github.com/Pennyw0rth/NetExec) (Python) can be used to remotely dump SAM and LSA secrets, on multiple hosts. It offers several authentication methods like [pass-the-hash](/ad/movement/ntlm/pth) (NTLM), or [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) (Kerberos)
...
Alternatively, from a live Windows machine, the hive files can also be exfiltrated using [Volume Shadow Copy](/redteam/credentials/os-credentials/windows-and-active-directory/ntds) like demonstrated for an NTDS export.
...
<ResourceCard href="https://www.thehacker.recipes/ad/movement/credentials/dumping/sam-and-lsa-secrets" title="SAM & LSA secrets | The Hacker Recipes" description="www.thehacker.recipes" icon="/assets/favicons/www.thehacker.recipes.png" />

<ResourceCard href="http://moyix.blogspot.com/2008/02/syskey-and-sam.html" title="SysKey and the SAM" description="moyix.blogspot.com" icon="/assets/favicons/moyix.blogspot.com.ico" />

<ResourceCard href="http://moyix.blogspot.com/2008/02/decrypting-lsa-secrets.html" title="Decrypting LSA Secrets" description="moyix.blogspot.com" icon="/assets/favicons/moyix.blogspot.com.ico" />

<ResourceCard href="https://medium.com/@benichmt1/secretsdump-demystified-bfd0f933dd9b" title="medium.com" description="medium.com" icon="/assets/favicons/medium.com.ico" />

<ResourceCard href="https://webstersprodigy.net/2014/02/03/mscash-hash-primer-for-pentesters/" title="webstersprodigy.net" description="webstersprodigy.net" />
