...
Once the secrets are extracted, they can be used for various attacks: [credential spraying](/ad/movement/credentials/bruteforcing/password-spraying), [stuffing](/ad/movement/credentials/bruteforcing/stuffing), [shuffling](/ad/movement/credentials/credential-shuffling), [cracking](/ad/movement/credentials/cracking), [pass-the-hash](/ad/movement/ntlm/pth), [overpass-the-hash](/ad/movement/kerberos/pass-the/ptk) or [silver or golden tickets](../../../../ad/movement/kerberos/forged-tickets.md).
...
Just like with [SAM & LSA secrets](/redteam/credentials/os-credentials/windows-and-active-directory/sam-and-lsa-secrets), the SYSTEM registry hive contains enough info to decrypt the NTDS.dit data. The hive file (`\system32\config\system`) can either be exfiltrated the same way the NTDS.dit file is, or it can be exported with `reg save HKLM\SYSTEM 'C:\Windows\Temp\system.save'`.

<Tabs items={['UNIX-Like', 'Windows', 'NTDS Parsing']}>
<Tab value="UNIX-Like">

#### Secretsdump.py

[Impacket](https://github.com/SecureAuthCorp/impacket)'s [secretsdump](https://github.com/SecureAuthCorp/impacket/blob/master/examples/secretsdump.py) (Python) can be used to remotely dump NTDS.dit through Volume Shadow Copy. Several authentication methods can be used like [pass-the-hash](/ad/movement/ntlm/pth) (LM/NTLM), or [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) (Kerberos).
...
[NetExec](https://github.com/Pennyw0rth/NetExec) (Python) can also be used to remotely dump NTDS.dit through Volume Shadow Copy or NTDSUtil. It offers several authentication methods like [pass-the-hash](/ad/movement/ntlm/pth) (NTLM), or [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) (Kerberos)
...
<ResourceCard href="https://www.thehacker.recipes/ad/movement/credentials/dumping/ntds" title="NTDS secrets | The Hacker Recipes" description="www.thehacker.recipes" icon="/assets/favicons/www.thehacker.recipes.png" />
