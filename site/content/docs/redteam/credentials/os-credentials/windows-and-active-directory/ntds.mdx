...
Once the secrets are extracted, they can be used for various attacks: [credential spraying](/ad/movement/credentials/bruteforcing/password-spraying), [stuffing](/ad/movement/credentials/bruteforcing/stuffing), [shuffling](/ad/movement/credentials/credential-shuffling), [cracking](/ad/movement/credentials/cracking), [pass-the-hash](/ad/movement/ntlm/pth), [overpass-the-hash](/ad/movement/kerberos/ptk) or [silver or golden tickets](../../../../ad/movement/kerberos/forged-tickets.md).
...
[Impacket](https://github.com/SecureAuthCorp/impacket)'s [secretsdump](https://github.com/SecureAuthCorp/impacket/blob/master/examples/secretsdump.py) (Python) can be used to remotely dump NTDS.dit through Volume Shadow Copy. Several authentication methods can be used like [pass-the-hash](/ad/movement/ntlm/pth) (LM/NTLM), or [pass-the-ticket](/ad/movement/kerberos/ptt) (Kerberos).
...
[NetExec](https://github.com/Pennyw0rth/NetExec) (Python) can also be used to remotely dump NTDS.dit through Volume Shadow Copy or NTDSUtil. It offers several authentication methods like [pass-the-hash](/ad/movement/ntlm/pth) (NTLM), or [pass-the-ticket](/ad/movement/kerberos/ptt) (Kerberos)
