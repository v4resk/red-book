...
* **SAM**: Interface for the [SAM database](/redteam/credentials/os-credentials/windows-and-active-directory/sam-and-lsa-secrets).
* **Vault**: Allowing to manage credentials in the [Windows Credential Manager](/redteam/credentials/password-stores/windows-credential-manager).
...
* **DPAPI**: [Data Protection API](/redteam/credentials/os-credentials/windows-and-active-directory/dpapi-protected-secrets) Interface for the CryptAPI library, allowing to protect data.
...
<Figure src="/assets/lsass-rpc-shcema.png" />
...
<Tabs items={['Lsassy', 'Mimikatz', 'Pypykatz', 'ProcDump', 'comsvcs.dll', 'PowerSploit']}>
<Tab value="Lsassy">
...
* several authentication methods: like [pass-the-hash](/ad/movement/ntlm/pth) (NTLM), or [pass-the-ticket](/ad/movement/kerberos/pass-the/ptt) (Kerberos)
...
Recovered credential material could be either plaintext passwords or NT hash that can be used with [pass the hash](/ad/movement/ntlm/pth) (depending on the context).
...
<Tabs items={['Mimikatz', 'Custom DLL']}>
<Tab value="Mimikatz">
...
<ResourceCard href="https://www.thehacker.recipes/ad/movement/credentials/dumping/lsass" title="LSASS secrets | The Hacker Recipes" description="www.thehacker.recipes" icon="/assets/favicons/www.thehacker.recipes.png" />

<ResourceCard href="https://en.hackndo.com/remote-lsass-dump-passwords/" title="Extract credentials from lsass remotely" description="en.hackndo.com" icon="/assets/favicons/en.hackndo.com.png" />

<ResourceCard href="https://www.ired.team/offensive-security/credential-access-and-credential-dumping/intercepting-logon-credentials-via-custom-security-support-provider-and-authentication-package" title="Intercepting Logon Credentials via Custom Security Support Provider and Authentication Packages | Red Team Not" description="www.ired.team" />
