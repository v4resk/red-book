---
title: "Security Support Provider DLLs"
description: ">-"
---
...
<Tabs items={['Mimikatz', 'PowerSploit', 'Custom DLL']}>
<Tab value="Mimikatz">
...
<Card href="/redteam/credentials/os-credentials/windows-and-active-directory/lsass" title="C6Vpv3xUMS9ZCJbiIbbe" />

## Resources

<ResourceCard href="https://attack.mitre.org/techniques/T1547/005/" title="Boot or Logon Autostart Execution: Security Support Provider, Sub-technique T1547.005 - Enterprise | MITRE ATT" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />

<ResourceCard href="https://pentestlab.blog/2019/10/21/persistence-security-support-provider/" title="Persistence \u2013 Security Support Provider" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.png" />
