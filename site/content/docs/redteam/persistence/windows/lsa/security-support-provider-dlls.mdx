...
<ResourceCard href="https://pentestlab.blog/2019/10/21/persistence-security-support-provider/" title="Persistence \u2013 Security Support Provider" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.ico" />
