...
<ResourceCard href="https://pentestlab.blog/2019/11/13/persistence-accessibility-features/" title="Persistence \u2013 Accessibility Features" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.ico" />
