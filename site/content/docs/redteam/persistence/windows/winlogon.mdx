...
<Tabs items={['Userinit ', 'Shell', 'Notify']}>
<Tab value="Userinit ">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1547/004/" title="Boot or Logon Autostart Execution: Winlogon Helper DLL, Sub-technique T1547.004 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
