...
<Tabs items={['Run/RunOnce/RunOnceEx', 'RunServices/RunServicesOnce ', 'Policies']}>
<Tab value="Run/RunOnce/RunOnceEx">
...
<Tab value="RunServices/RunServicesOnce ">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1547/001/" title="Boot or Logon Autostart Execution: Registry Run Keys / Startup Folder, Sub-technique T1547.001 - Enterprise | " description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
