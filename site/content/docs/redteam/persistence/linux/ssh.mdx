...
<Tabs items={['Backdooring Public Keys', 'authorized_keys']}>
<Tab value="Backdooring Public Keys">
...
<ResourceCard href="https://blog.thc.org/infecting-ssh-public-keys-with-backdoors" title="Infecting SSH Public Keys with backdoors" description="blog.thc.org" icon="/assets/favicons/blog.thc.org.png" />

<ResourceCard href="https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Linux%20-%20Persistence.md" title="PayloadsAllTheThings/Methodology and Resources/Linux - Persistence.md at master \u00b7 swisskyrepo/PayloadsAllTheTh" description="github.com" icon="/assets/favicons/github.com.png" />
