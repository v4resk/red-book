...
<ResourceCard href="https://blog.thc.org/infecting-ssh-public-keys-with-backdoors" title="Infecting SSH Public Keys with backdoors" description="blog.thc.org" icon="/assets/favicons/blog.thc.org.ico" />
