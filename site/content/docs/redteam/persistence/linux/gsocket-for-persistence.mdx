...
<Tabs items={['Persistence Script', 'Systemd Persistence', 'SSH-Based Persistence']}>
<Tab value="Persistence Script">
...
<Tab value="SSH-Based Persistence">
...
<ResourceCard href="https://github.com/hackerschoice/gsocket" title="GitHub - hackerschoice/gsocket: Connect like there is no firewall. Securely." description="github.com" icon="/assets/favicons/github.com.png" />

<ResourceCard href="https://www.gsocket.io/" title="Global Socket" description="www.gsocket.io" icon="/assets/favicons/www.gsocket.io.png" />
