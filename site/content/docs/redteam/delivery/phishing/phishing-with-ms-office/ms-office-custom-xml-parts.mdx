---
title: "MS Office - Custom XML parts"
---
...
<Figure src="/assets/image-20250402233751303.png" />
...
<Figure src="/assets/image-20250402233907239.png" />

Click "Custom XML Part" --> "Add"

<Figure src="/assets/image-20250402233954559.png" />

And finally select the previously generated Custom XML Part.

<Figure src="/assets/image-20250402234128100.png" />
...
<Figure src="/assets/CustomXMLPart2.gif" />

### Tools - Automate The Process

<Tabs items={['Automated']}>
<Tab value="Automated">
...
<ResourceCard href="https://mgeeky.tech/payload-crumbs-in-custom-parts/" title="Backdooring Office Structures. Part 2: Payload Crumbs In Custom Parts \u2013 mgeeky's lair" description="mgeeky.tech" icon="/assets/favicons/mgeeky.tech.png" />
