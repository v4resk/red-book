...
<Tabs items={['Basic Usage', 'ActiveX Macro', 'Shellcode Runners', 'Ivy', 'Unicorn']}>
...
Then, add the following macro in your word document (see [Basic Usage](/redteam/delivery/phishing/phishing-with-ms-office/vba#basic-usage)) using the generated payload
