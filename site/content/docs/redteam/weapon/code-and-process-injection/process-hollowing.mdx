...
<Figure src="/assets/process-hollowing.png">Process Hollowing - TryHackMe</Figure>
## Practice
...
<ResourceCard href="https://attack.mitre.org/techniques/T1055/012/" title="Process Injection: Process Hollowing, Sub-technique T1055.012 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />

<ResourceCard href="https://tryhackme.com/room/abusingwindowsinternals" title="tryhackme.com" description="tryhackme.com" />

<ResourceCard href="https://www.ired.team/offensive-security/code-injection-process-injection/process-hollowing-and-pe-image-relocations" title="Process Hollowing and Portable Executable Relocations | Red Team Notes" description="www.ired.team" />
