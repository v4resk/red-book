---
title: "Loading .NET Reflective Assembly"
...
<Tabs items={['Classic', 'XORed', 'Base64 + Gzip', 'Custom .NET DLL']}>
<Tab value="Classic">
...
<Tabs items={['Assembly.Load()', 'Assembly.LoadFile()', 'SharpSploit - 1', 'SharpSploit - 2']}>
<Tab value="Assembly.Load()">
...
<Tabs items={['unmanaged.cpp', 'managed.cs']}>
<Tab value="unmanaged.cpp">
...
<Tabs items={['Evil-WinRm', 'PowerSharpPack']}>
<Tab value="Evil-WinRm">
...
<ResourceCard href="https://ppn.snovvcrash.rocks/pentest/infrastructure/ad/av-edr-evasion/dotnet-reflective-assembly" title="ppn.snovvcrash.rocks" description="ppn.snovvcrash.rocks" />

<ResourceCard href="https://stackoverflow.com/questions/14479074/c-sharp-reflection-load-assembly-and-invoke-a-method-if-it-exists" title="stackoverflow.com" description="stackoverflow.com" icon="/assets/favicons/stackoverflow.com.png" />

<ResourceCard href="https://blog.king-sabri.net/red-team/executing-c-assembly-in-memory-using-assembly.load" title="blog.king-sabri.net" description="blog.king-sabri.net" />

<ResourceCard href="https://www.ired.team/offensive-security/code-injection-process-injection/injecting-and-executing-.net-assemblies-to-unmanaged-process" title="Injecting .NET Assembly to an Unmanaged Process | Red Team Notes" description="www.ired.team" />
