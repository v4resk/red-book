---
title: "Module Stomping Shellcode Injection"
---
...
<Tabs items={['C++ (Local Process)', 'C++ (Remote Process)']}>
<Tab value="C++ (Local Process)">
...
<ResourceCard href="https://www.ired.team/offensive-security/code-injection-process-injection/modulestomping-dll-hollowing-shellcode-injection" title="Module Stomping for Shellcode Injection | Red Team Notes" description="www.ired.team" />
