...
<ResourceCard href="https://www.ired.team/offensive-security/code-execution/using-msbuild-to-execute-shellcode-in-c" title="Using MSBuild to Execute Shellcode in C# | Red Team Notes" description="www.ired.team" />
