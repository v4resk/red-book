---
title: "Outlook Home Page Abuse (Specula)"
---
...
<Tabs items={['Setting up', 'Hook an agent', 'Execute']}>
<Tab value="Setting up">
...
<Figure src="/assets/image (11).png" />
...
<Figure src="/assets/image (1) (3).png" />
...
<ResourceCard href="https://trustedsec.com/resources/tools/specula" title="trustedsec.com" description="trustedsec.com" />

<ResourceCard href="https://github.com/trustedsec/specula/wiki" title="Home" description="github.com" icon="/assets/favicons/github.com.png" />
