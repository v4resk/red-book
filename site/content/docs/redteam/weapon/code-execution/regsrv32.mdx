...
<Tabs items={['Regsvr32.exe']}>
<Tab value="Regsvr32.exe">
...
<ResourceCard href="https://www.ired.team/offensive-security/code-execution/t1117-regsvr32-aka-squiblydoo" title="regsvr32 | Red Team Notes" description="www.ired.team" />
