...
<Tabs items={['Basic Usage', 'pubprn.vbs']}>
...
<ResourceCard href="https://www.ired.team/offensive-security/code-execution/t1216-signed-script-ce" title="pubprn.vbs Signed Script Code Execution | Red Team Notes" description="www.ired.team" />
