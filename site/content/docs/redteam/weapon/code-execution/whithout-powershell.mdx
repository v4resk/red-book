...
<Tabs items={['PowerLessShell', 'NoPowershell', 'PowerShdll', 'SyncAppvPublishingServer', 'C#']}>
<Tab value="PowerLessShell">
...
<Tab value="SyncAppvPublishingServer">
...
<ResourceCard href="https://www.ired.team/offensive-security/code-execution/powershell-without-powershell" title="Powershell Without Powershell.exe | Red Team Notes" description="www.ired.team" />
