...
<Card href="/redteam/pivoting/remote-wmi" title="Remote WMI" />

## Resources

<ResourceCard href="https://tryhackme.com/room/livingofftheland" title="tryhackme.com" description="tryhackme.com" />

<ResourceCard href="https://www.ired.team/offensive-security/code-execution/application-whitelisting-bypass-with-wmic-and-xsl" title="Application Whitelisting Bypass with WMIC and XSL | Red Team Notes" description="www.ired.team" />
