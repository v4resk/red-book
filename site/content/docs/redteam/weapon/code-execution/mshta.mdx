...
<Tabs items={['Basic HTA', 'scriptlet', 'SharpShooter', 'msfvenom', 'metasploit']}>
<Tab value="Basic HTA">
...
<ResourceCard href="https://www.ired.team/offensive-security/code-execution/t1170-mshta-code-execution" title="MSHTA | Red Team Notes" description="www.ired.team" />
