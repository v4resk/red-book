...
<Figure src="/assets/35e16d45ce27145fcdf231fdb8dcb35e.png" />
...
<Figure src="/assets/efca9438e858f0476a4ffd777c36501a.png" />
...
<Tabs items={['PowerShell', 'C# DLL Loading ', 'C++ DLL Loading', 'Remote Process Patching (C#)']}>
<Tab value="PowerShell">
...
<Tab value="Remote Process Patching (C#)">
...
<Tabs items={['AMSI.Fail', 'Evil-Winrm', 'AMSITrigger', 'AMSI-Killer']}>
<Tab value="AMSI.Fail">
...
<ResourceCard href="https://tryhackme.com/room/runtimedetectionevasion" title="tryhackme.com" description="tryhackme.com" />
