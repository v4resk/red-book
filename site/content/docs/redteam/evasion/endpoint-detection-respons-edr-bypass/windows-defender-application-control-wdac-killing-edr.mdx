---
title: "Windows Defender Application Control (WDAC): Killing EDR"
...
<Figure src="/assets/image-20241009110409414.png" />

2. Select the "AllowAll" template from `C:\Windows\Schemas\CodeIntgrity\ExamplePolicies\AllowAll.xml` and click "Next"

<Figure src="/assets/image-20241009110346223.png" />

3. Ensure that "Audit Mode" is Unchecked, click "Next"

<Figure src="/assets/image-20241008151153062.png" />

4. Click "Add Custom"

<Figure src="/assets/image-20241009111120016.png" />
...
<Figure src="/assets/image-20241008161514514.png" />
...
<Figure src="/assets/image (1) (1) (1) (1).png" />
...
<ResourceCard href="https://beierle.win/2024-12-20-Weaponizing-WDAC-Killing-the-Dreams-of-EDR/" title="Weaponizing WDAC: Killing the Dreams of EDR" description="beierle.win" icon="/assets/favicons/beierle.win.ico" />

<ResourceCard href="https://x.com/0x64616e/status/1822041831573479479" title="Daniel (@0x64616e) on X" description="x.com" icon="/assets/favicons/x.com.ico" />
