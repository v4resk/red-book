...
<Tabs items={['procexp.sys ', 'truesight.sys', 'zam64.sys']}>
<Tab value="procexp.sys ">
...
<Tabs items={['EDRSandblast']}>
<Tab value="EDRSandblast">
...
<Tabs items={['DriverJack']}>
<Tab value="DriverJack">
...
<ResourceCard href="https://www.trendmicro.com/en_us/research/24/a/kasseika-ransomware-deploys-byovd-attacks-abuses-psexec-and-expl.html" title="Kasseika Ransomware Deploys BYOVD Attacks Abuses PsExec and Exploits Martini Driver" description="www.trendmicro.com" icon="/assets/favicons/www.trendmicro.com.png" />
