---
title: "hypervisor-protected code integrity (HVCI) Bypass"
wip: true
icon: Construction
---
...
<Figure src="/assets/image-20240831142055836.png">Load in RW --> Set RX after verifying</Figure>
## Practice
...
<ResourceCard href="https://connormcgarr.github.io/hvci/" title="Exploit Development: No Code Execution? No Problem! Living The Age of VBS, HVCI, and Kernel CFG" description="connormcgarr.github.io" />
