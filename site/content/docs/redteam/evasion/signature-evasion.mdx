...
<Figure src="/assets/image (17).png" />
...
<Tabs items={['GoCheck', 'ThreatCheck', 'AMSITrigger', 'ExpandDefenderSig.ps1']}>
<Tab value="GoCheck">
...
<Figure src="/assets/image (28).png" />

</Tab>

<Tab value="ThreatCheck">
...
<Tab value="ExpandDefenderSig.ps1">
...
<Figure src="/assets/image (1) (1).png" />
...
<Card href="/redteam/evasion/obf" title="Obfuscation" />

## Resources

<ResourceCard href="https://tryhackme.com/r/room/signatureevasion" title="tryhackme.com" description="tryhackme.com" />
