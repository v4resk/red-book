---
title: "Mark-of-the-Web (MotW) Bypass"
description: ">-"
---
...
<Figure src="/assets/image (18).png" />
...
<Tabs items={['PackMyPayload.py']}>
<Tab value="PackMyPayload.py">
...
<Figure src="/assets/NoMoTW2.gif">PackMyPayload Testings</Figure>
</Tab>
</Tabs>

## Resources

<ResourceCard href="https://redcanary.com/threat-detection-report/techniques/mark-of-the-web-bypass/" title="Mark of the Web Bypass - Red Canary Threat Detection Report" description="redcanary.com" icon="/assets/favicons/redcanary.com.png" />

<ResourceCard href="https://attack.mitre.org/techniques/T1553/005/" title="Subvert Trust Controls: Mark-of-the-Web Bypass, Sub-technique T1553.005 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
