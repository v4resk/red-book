...
<ResourceCard href="https://blog.ploetzli.ch/2014/understanding-linux-capabilities/" title="Understanding Capabilities in Linux - Tinker, Tamper, Alter, Fry" description="blog.ploetzli.ch" icon="/assets/favicons/blog.ploetzli.ch.ico" />
