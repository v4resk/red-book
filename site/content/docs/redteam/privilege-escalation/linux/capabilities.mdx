...
<Tabs items={['CapEff', 'CapPrm', 'CapInh', 'CapBnd', 'CapAmb']}>
<Tab value="CapEff">
...
<Tabs items={['Desc', 'Exploit - Python']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit - Gdb']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit -  kmod']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit - Tar']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit Vim']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit - Ruby']}>
<Tab value="Desc">
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit - Ruby', 'Exploit - Perl', 'Exploit - PHP']}>
<Tab value="Desc">
...
Once you have [SETUID capability](/redteam/privilege-escalation/linux/capabilities#cap\_setuid) you can go to its section to see how to escalate privileges.
...
<Tabs items={['Desc', 'Exploit - Python', 'Exploit - Tcpdump']}>
<Tab value="Desc">
...
<ResourceCard href="https://book.hacktricks.xyz/linux-hardening/privilege-escalation/linux-capabilities" title="Page not found - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />

<ResourceCard href="https://blog.ploetzli.ch/2014/understanding-linux-capabilities/" title="Understanding Capabilities in Linux - Tinker, Tamper, Alter, Fry" description="blog.ploetzli.ch" icon="/assets/favicons/blog.ploetzli.ch.png" />
