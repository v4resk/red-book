...
<Tabs items={['Exploit - 1', 'Exploit - 2', 'Exploit - With Internet']}>
<Tab value="Exploit - 1">
...
<Tab value="Exploit - With Internet">
...
<ResourceCard href="https://book.hacktricks.xyz/linux-hardening/privilege-escalation/interesting-groups-linux-pe/lxd-privilege-escalation" title="Page not found - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />

<ResourceCard href="https://www.hackingarticles.in/lxd-privilege-escalation/" title="Lxd Privilege Escalation" description="www.hackingarticles.in" icon="/assets/favicons/www.hackingarticles.in.png" />
