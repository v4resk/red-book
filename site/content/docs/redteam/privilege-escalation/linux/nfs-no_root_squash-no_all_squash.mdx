---
title: "NFS no\\_root\\_squash/no\\_all\\_squash"
---
...
<Tabs items={['Enumerate', 'Exploit - Remote', 'Exploit - Local']}>
<Tab value="Enumerate">
...
When [listing the NFS shares](/network-pentesting/protocols/nfs#showmount), it will show IP allowed to mount the share:
...
<ResourceCard href="https://book.hacktricks.xyz/linux-hardening/privilege-escalation/nfs-no_root_squash-misconfiguration-pe" title="Page not found - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />

<ResourceCard href="https://www.errno.fr/nfs_privesc.html" title="A tale of a lesser known NFS privesc" description="www.errno.fr" />
