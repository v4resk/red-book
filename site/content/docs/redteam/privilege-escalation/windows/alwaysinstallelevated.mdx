...
<Tabs items={['Enumerate - UNIX-like', 'Enumerate - Windows', 'Exploit']}>
<Tab value="Enumerate - UNIX-like">
...
<ResourceCard href="https://juggernaut-sec.com/alwaysinstallelevated/" title="AlwaysInstallElevated \u2013 Windows Privilege Escalation" description="juggernaut-sec.com" icon="/assets/favicons/juggernaut-sec.com.png" />
