...
<ResourceCard href="https://medium.com/@SumitVerma101/windows-privilege-escalation-part-1-unquoted-service-path-c7a011a8d8ae" title="medium.com" description="medium.com" icon="/assets/favicons/medium.com.ico" />

<ResourceCard href="https://github.com/swisskyrepo/PayloadsAllTheThings/blob/master/Methodology%20and%20Resources/Windows%20-%20Privilege%20Escalation.md#eop---unquoted-service-paths" title="PayloadsAllTheThings/Methodology and Resources/Windows - Privilege Escalation.md at master \u00b7 swisskyrepo/Paylo" description="github.com" icon="/assets/favicons/github.com.png" />
