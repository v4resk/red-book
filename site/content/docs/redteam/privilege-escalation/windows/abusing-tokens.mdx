...
<Tabs items={['FullPowers', 'EnableAllTokenPrivs']}>
<Tab value="FullPowers">
...
<Tabs items={['Churrasco', 'Juicy-Potato', 'PrintSpoofer', 'RoguePotato', 'GodPotato']}>
<Tab value="Churrasco">
...
<ResourceCard href="https://book.hacktricks.xyz/windows-hardening/windows-local-privilege-escalation/privilege-escalation-abusing-tokens/abuse-seloaddriverprivilege" title="Page not found - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />
...
<ResourceCard href="https://book.hacktricks.xyz/windows-hardening/windows-local-privilege-escalation/privilege-escalation-abusing-tokens" title="Abusing Tokens - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />
