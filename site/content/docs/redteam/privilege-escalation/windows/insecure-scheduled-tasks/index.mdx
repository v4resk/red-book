...
<Card href="../../../discovery/windows/scheduled-tasks.md" title="scheduled-tasks.md" />

### Exploit

<Card href="weak-file-folder-permissions.md" title="weak-file-folder-permissions.md" />
