...
Using ligolo-ng, we can perform SYN scan or send ICMP packets trought the created interface. (in contrast with SOCKS pivoting techniques like with [Chisel](/redteam/pivoting/portfwd#chisel) or [SSH](/redteam/pivoting/portfwd#ssh-tunneling)).

</Callout>

## Practice

<Tabs items={['Using Ligolo-ng', 'Setup']}>
<Tab value="Using Ligolo-ng">

<Callout type="info">

Before using it, you should first [Setup Ligolo-ng](/redteam/pivoting/tls-tunneling-ligolo-ng#setup).
...
<ResourceCard href="https://github.com/nicocha30/ligolo-ng/tree/v0.4.4#building--usage" title="GitHub - nicocha30/ligolo-ng at v0.4.4" description="github.com" icon="/assets/favicons/github.com.png" />
