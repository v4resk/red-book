...
<Tabs items={['UNIX-like', 'Windows - Powershell', 'Windows - wmic.exe']}>
<Tab value="UNIX-like">
...
<Tabs items={['Windows - Powershell', 'Windows - wmic.exe']}>
<Tab value="Windows - Powershell">
...
Using WMI on a remote endpoint, we can perform lateral movements based on[ WMI Event Subscription Persitence](/redteam/persistence/windows/wmi-event-subscription).
...
<Tabs items={['Windows - Powershell', 'Windows - wmic.exe', 'C#']}>
<Tab value="Windows - Powershell">
...
<ResourceCard href="https://tryhackme.com/room/lateralmovementandpivoting" title="tryhackme.com" description="tryhackme.com" />

<ResourceCard href="https://pentestlab.blog/2020/01/21/persistence-wmi-event-subscription/" title="Persistence \u2013 WMI Event Subscription" description="pentestlab.blog" icon="/assets/favicons/pentestlab.blog.png" />

<ResourceCard href="https://www.ired.team/offensive-security/lateral-movement/wmi-via-newscheduledtask" title="WMI + NewScheduledTaskAction Lateral Movement | Red Team Notes" description="www.ired.team" />

<ResourceCard href="https://www.ired.team/offensive-security/lateral-movement/wmi-+-msi-lateral-movement" title="WMI + MSI Lateral Movement | Red Team Notes" description="www.ired.team" />
