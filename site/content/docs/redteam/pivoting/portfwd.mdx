...
<Figure src="/assets/PortFrwd.png">Example of Network layout in a Classic Port Forwarding Scenario</Figure>
...
By using a SSH client with an OpenSSH server, it's possible to create both forward (local) and reverse (remote) connections to make [SSH tunnels](/redteam/pivoting/portfwd#ssh-tunneling), allowing us to forward ports, and/or create proxies.
...
<Tabs items={['Local Forwarding', 'Remote Forwarding', 'Forward Proxy', 'Reverse Proxy']}>
<Tab value="Local Forwarding">
...
<Tabs items={['Local Forwarding', 'Remote Forwarding']}>
<Tab value="Local Forwarding">
...
<Tabs items={['Reverse Proxy', 'Local Proxy', 'Remote Forwarding', 'Local Forwarding']}>
<Tab value="Reverse Proxy">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1572/" title="Protocol Tunneling, Technique T1572 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />

<ResourceCard href="https://podalirius.net/en/articles/ssh-port-forwarding/" title="SSH Port forwarding" description="podalirius.net" />
