...
<Tabs items={['UNIX-like', 'Windows - Powershell']}>
<Tab value="UNIX-like">
...
<Card href="/redteam/weapon/code-and-process-injection/remote-.net-assembly-loading-through-waasremediation-dcom-abuse" title="Remote .NET Assembly Loading through WaaSRemediation DCOM Abuse" />
...
<Tabs items={['Windows - Powershell', 'XLL Code source']}>
<Tab value="Windows - Powershell">
...
<ResourceCard href="https://www.cybereason.com/blog/leveraging-excel-dde-for-lateral-movement-via-dcom" title="Leveraging Excel DDE for lateral movement via DCOM" description="www.cybereason.com" icon="/assets/favicons/www.cybereason.com.png" />

<ResourceCard href="https://www.exploit-db.com/exploits/48767" title="Abusing COM & DCOM objects - Paper" description="www.exploit-db.com" icon="/assets/favicons/www.exploit-db.com.png" />

<ResourceCard href="https://www.ired.team/offensive-security/lateral-movement/t1175-distributed-component-object-model" title="Lateral Movement via DCOM | Red Team Notes" description="www.ired.team" />

<ResourceCard href="https://book.hacktricks.xyz/windows-hardening/lateral-movement/dcom-exec" title="Page not found - HackTricks" description="book.hacktricks.xyz" icon="/assets/favicons/book.hacktricks.xyz.svg" />
