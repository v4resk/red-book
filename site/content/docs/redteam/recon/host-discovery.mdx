...
By default, on an ethernet LAN, nmap will perform an [ARP scan](/redteam/recon/host-discovery#arp-scan).
...
<ResourceCard href="https://nmap.org/book/host-discovery-techniques.html" title="Host Discovery Techniques | Nmap Network Scanning" description="nmap.org" icon="/assets/favicons/nmap.org.png" />
