...
<Tabs items={['Dig', 'Host', 'Nslookup', 'DNSRecon', 'DNSMap', 'DNSEnum', 'dnsdumpster']}>
<Tab value="Dig">
...
<ResourceCard href="https://attack.mitre.org/techniques/T1590/002/" title="Gather Victim Network Information: DNS, Sub-technique T1590.002 - Enterprise | MITRE ATT&CK" description="attack.mitre.org" icon="/assets/favicons/attack.mitre.org.png" />
