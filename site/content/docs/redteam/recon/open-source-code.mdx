...
<Tabs items={['Github Dorks', 'GitHound', 'Noseyparker', 'GitHunt', 'Gitleaks', 'Gitrob']}>
<Tab value="Github Dorks">
...
<Figure src="/assets/Capture dՎcran_2024-08-22_00-29-55 (1).png" />
...
<ResourceCard href="https://github.com/techgaun/github-dorks" title="GitHub - techgaun/github-dorks: Find leaked secrets via github search" description="github.com" icon="/assets/favicons/github.com.png" />
