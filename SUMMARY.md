...
* [Initial Access](redteam/delivery/README.md)
  ...
  * [Password Attacks](redteam/delivery/passwd/README.md)
    * [Default, weak & Leaked Passwords](redteam/delivery/passwd/default-weak-and-leaked-passwords.md)
    ...
    * [Brute-Force](redteam/delivery/passwd/brute-force/README.md)
      * [Online - Attacking Services](redteam/delivery/passwd/brute-force/online-attacking-services.md)
      * [Offline - Password Cracking](redteam/delivery/passwd/brute-force/offline-password-cracking.md)
...
* [Persistence](redteam/persistence/README.md)
  ...
  * [Windows](redteam/persistence/persistence/README.md)
    * [Accessibility features Backdoor](redteam/persistence/persistence/accessibility-features-backdoor.md)
    * [AEDebug Keys](redteam/persistence/persistence/aedebug-keys.md)
    * [Image File Execution Options](redteam/persistence/persistence/image-file-execution-options.md)
    * [Logon Triggered](redteam/persistence/persistence/logon-triggered.md)
    * [LSA](redteam/persistence/persistence/lsa/README.md)
      * [Security Support Provider DLLs](redteam/persistence/persistence/lsa/security-support-provider-dlls.md)
      * [Authentication Package](redteam/persistence/persistence/lsa/authentication-package.md)
    * [Natural Language 6 DLLs](redteam/persistence/persistence/natural-language-6-dlls.md)
    * [Run Keys](redteam/persistence/persistence/run-keys.md)
    * [Winlogon](redteam/persistence/persistence/winlogon.md)
    * [WMI Event Subscription](redteam/persistence/persistence/wmi-event-subscription.md)
  * [Linux](redteam/persistence/persistence-1/README.md)
    * [SSH](redteam/persistence/persistence-1/ssh.md)
* [Defense Evasion](redteam/evasion/README.md)
  ...
  * [🛠️ Obfuscation](redteam/evasion/obf/README.md)
* [Discovery](redteam/discovery/README.md)
  * [Active Directory](redteam/discovery/active-directory.md)
  * [Windows](redteam/discovery/recon/README.md)
    * [System Information](redteam/discovery/recon/system-information.md)
    * [Processes & Services](redteam/discovery/recon/processes-and-services.md)
    * [Scheduled Tasks](redteam/discovery/recon/scheduled-tasks.md)
    * [Installed applications](redteam/discovery/recon/installed-applications.md)
    * [Network Configuration](redteam/discovery/recon/network-configuration.md)
    * [FIle/Folder ACLs](redteam/discovery/recon/acls.md)
    * [Knowing your Shell](redteam/discovery/recon/knowing-your-shell.md)
    * [Security Solutions](redteam/discovery/recon/av.md)
  * [Linux](redteam/discovery/reconnaissance/README.md)
    * [OS Details](redteam/discovery/reconnaissance/os-details.md)
    * [🛠️ Process & Services](redteam/discovery/reconnaissance/process-and-services.md)
* [Privilege Escalation](redteam/privilege-escalation/README.md)
  * [Windows](redteam/privilege-escalation/privesc/README.md)
    * [Tools ⚙️](redteam/privilege-escalation/privesc/tools.md)
    * [PowerShell Logging](redteam/privilege-escalation/privesc/powershell-logging.md)
    * [Credentials In Files](redteam/privilege-escalation/privesc/credentials-in-files.md)
    * [Abusing Tokens](redteam/privilege-escalation/privesc/abusing-tokens.md)
    * [Insecure Services](redteam/privilege-escalation/privesc/services/README.md)
      * [Weak Service Permissions](redteam/privilege-escalation/privesc/services/weak-service-permissions.md)
      * [Weak File/Folder Permissions](redteam/privilege-escalation/privesc/services/weak-files-permissions.md)
      * [Weak Registry Permissions](redteam/privilege-escalation/privesc/services/weak-registry-permissions.md)
      * [Unquoted Service Path](redteam/privilege-escalation/privesc/services/unquoted-service-path.md)
    * [AlwaysInstallElevated](redteam/privilege-escalation/privesc/alwaysinstallelevated.md)
    * [AutoLogon Registry](redteam/privilege-escalation/privesc/autologon-registry.md)
    * [Insecure Scheduled Tasks](redteam/privilege-escalation/privesc/insecure-scheduled-tasks/README.md)
      * [Weak File/Folder Permissions](redteam/privilege-escalation/privesc/insecure-scheduled-tasks/weak-file-folder-permissions.md)
    * [🛠️ DLL Hijacking](redteam/privilege-escalation/privesc/dll-hijacking.md)
  * [Linux](redteam/privilege-escalation/privesc-1/README.md)
    * [Kernel Exploits](redteam/privilege-escalation/privesc-1/kernel-exploits/README.md)
      * [OverlayFs Exploits](redteam/privilege-escalation/privesc-1/kernel-exploits/overlayfs-exploits/README.md)
        * [GameOverlayFs](redteam/privilege-escalation/privesc-1/kernel-exploits/overlayfs-exploits/gameoverlayfs.md)
        * [CVE-2023-0386](redteam/privilege-escalation/privesc-1/kernel-exploits/overlayfs-exploits/cve-2023-0386-overlayfs.md)
        * [CVE-2021-3493](redteam/privilege-escalation/privesc-1/kernel-exploits/overlayfs-exploits/cve-2021-3493.md)
      * [CVE-2023-32233 (CAP\_NET\_ADMIN)](redteam/privilege-escalation/privesc-1/kernel-exploits/nf\_tables.md)
      * [Dirty Pipe](redteam/privilege-escalation/privesc-1/kernel-exploits/dirtypipe.md)
      * [🛠️ DirtyCow](redteam/privilege-escalation/privesc-1/kernel-exploits/dirtycow.md)
      * [🛠️ RDS](redteam/privilege-escalation/privesc-1/kernel-exploits/rds.md)
      * [🛠️ Full Nelson](redteam/privilege-escalation/privesc-1/kernel-exploits/full-nelson.md)
      * [🛠️ Mempodipper](redteam/privilege-escalation/privesc-1/kernel-exploits/mempodipper.md)
    * [GLIBC Exploits](redteam/privilege-escalation/privesc-1/glibc-exploits/README.md)
      * [Looney Tunables](redteam/privilege-escalation/privesc-1/glibc-exploits/looney-tunables.md)
    * [Polkit Exploits](redteam/privilege-escalation/privesc-1/polkit-exploits/README.md)
      * [PwnKit](redteam/privilege-escalation/privesc-1/polkit-exploits/pwnkit.md)
      * [D-Bus Authentication Bypass](redteam/privilege-escalation/privesc-1/polkit-exploits/d-bus-authentication-bypass.md)
    * [Sudo Exploits](redteam/privilege-escalation/privesc-1/sudo-exploits/README.md)
      * [Sudo Misconfigurations](redteam/privilege-escalation/privesc-1/sudo-exploits/sudo-misconfigurations.md)
      * [Sudo Binaries](redteam/privilege-escalation/privesc-1/sudo-exploits/sudo-binaries.md)
      * [Reuse Sudo Tokens](redteam/privilege-escalation/privesc-1/sudo-exploits/reuse-sudo-tokens.md)
      * [User Restriction Bypass](redteam/privilege-escalation/privesc-1/sudo-exploits/bypass-of-user-restrictions.md)
      * [Pwfeedback BOF](redteam/privilege-escalation/privesc-1/sudo-exploits/pwfeedback-bof.md)
      * [Baron Samedit](redteam/privilege-escalation/privesc-1/sudo-exploits/sudo-baron-samedit.md)
      * [Sudoedit Bypass](redteam/privilege-escalation/privesc-1/sudo-exploits/sudoedit-bypass.md)
    * [SUID Binaries](redteam/privilege-escalation/privesc-1/suid-binaries.md)
    * [Script Exploits](redteam/privilege-escalation/privesc-1/script-exploits/README.md)
      * [Python](redteam/privilege-escalation/privesc-1/script-exploits/python/README.md)
        * [Pip Download Code Execution](redteam/privilege-escalation/privesc-1/script-exploits/python/pypi-package.md)
        * [PyInstaller Code Execution](redteam/privilege-escalation/privesc-1/script-exploits/python/pyinstaller.md)
      * [Ruby](redteam/privilege-escalation/privesc-1/script-exploits/ruby.md)
      * [Bash](redteam/privilege-escalation/privesc-1/script-exploits/bash.md)
      * [Perl](redteam/privilege-escalation/privesc-1/script-exploits/perl.md)
    * [Scheduled tasks](redteam/privilege-escalation/privesc-1/scheduled-tasks/README.md)
      * [Cron Jobs](redteam/privilege-escalation/privesc-1/scheduled-tasks/cron-jobs.md)
      * [Systemd timers](redteam/privilege-escalation/privesc-1/scheduled-tasks/systemd-timers.md)
    * [Interesting Groups](redteam/privilege-escalation/privesc-1/groups/README.md)
      * [Lxd](redteam/privilege-escalation/privesc-1/groups/lxd.md)
    * [Capabilities](redteam/privilege-escalation/privesc-1/capabilities.md)
    * [NFS no\_root\_squash/no\_all\_squash](redteam/privilege-escalation/privesc-1/nfs-no\_root\_squash-no\_all\_squash.md)
    * [Linux Active Directory](redteam/privilege-escalation/privesc-1/linux-active-directory.md)
* [Credential Access](redteam/credential-access/README.md)
  * [Active Directory & Windows Credentials](redteam/credential-access/windows-and-active-directory.md)
  * [Credentials In Files](redteam/credential-access/credentials-in-files/README.md)
...
* [Movement](ad/movement/README.md)
  * [Credentials](ad/movement/credentials/README.md)
    * [Dumping](ad/movement/credentials/dumping/README.md)
      ...
      * [Cached Kerberos tickets](ad/movement/credentials/dumping/cached-kerberos-tickets.md)
      * [Local files](ad/movement/credentials/dumping/local-files.md)
